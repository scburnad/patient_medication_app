...
from patient_medication_app.core import models  # noqa: F401
from patient_medication_app.database.base import Base
    ...
    try:
        with engine.connect() as connection:
            context.configure(
                ...
                include_schemas=True,  # Include schemas in migration
            )
        ...
        print("Going to offline mode for migrations.")
